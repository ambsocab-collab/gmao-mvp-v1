...
The directory `excluded-docs/` contains documentation that must NOT be loaded into the LLM context. Do not read, index, or reference files in this directory unless explicitly requested by the user.